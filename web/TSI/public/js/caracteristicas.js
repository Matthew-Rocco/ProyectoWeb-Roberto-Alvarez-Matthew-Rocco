    ...
    if (tiposelec == 1) {
        caraccuerpo.innerHTML = `
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-10 col-md-10 col-lg-10 pe-0">
                                            <input type="number" placeholder="0" min="0"  class="form-control" id="peso-txt">
                                        </div>
                                        <div class="col col-md col-lg">
    ...
    `
        ...
        caraccuerpo.innerHTML = `
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" placeholder="0" min="0" class="form-control" id="conectores-txt">
                                </div>
                                <div class="mb-3">
                                    <label for="slotmem-txt" class="form-label">Slots de Memoria</label>
                                    <input type="number" placeholder="0" min="0"  class="form-control" id="slotmem-txt">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-10 col-md-10 col-lg-10 pe-0">
                                            <input type="number" placeholder="0" min="0"  class="form-control" id="maxmem-txt">
                                        </div>
                                        <div class="col col-md col-lg">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-10 col-md-10 col-lg-10 pe-0">
                                            <input type="number" placeholder="0" min="0" class="form-control" id="velocidad-txt">
                                        </div>
                                        <div class="col col-md col-lg">
        ...
        caraccuerpo.innerHTML = `
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-10 col-md-10 col-lg-10 pe-0">
                                            <input type="number" placeholder="0" min="0" class="form-control" id="consumo-txt">
                                        </div>
                                        <div class="col col-md col-lg">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-10 col-md-10 col-lg-10 pe-0">
                                            <input type="number" placeholder="0" min="0"  class="form-control" id="fgpu-txt">
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" placeholder="0" min="0" class="form-control" id="cnucleos-txt">
                                </div>
        `
    } else if (tiposelec == 4) {
        caraccuerpo.innerHTML = `
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-10 col-md-10 col-lg-10 pe-0">
                                            <input type="number" placeholder="0" min="0" class="form-control" id="cantmem-txt">
                                        </div>
                                        <div class="col col-md col-lg">
                                            <label class="form-label">GB</label>
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-10 col-md-10 col-lg-10 pe-0">
                                            <input type="number" placeholder="0" min="0" class="form-control" id="velocidadmem-txt">
                                        </div>
                                        <div class="col col-md col-lg pe-0">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-10 col-md-10 col-lg-10 pe-0">
                                            <input type="number" placeholder="0" min="0" class="form-control" id="tamañot-txt">
                                        </div>
                                        <div class="col col-md col-lg pe-0">
        ...
        caraccuerpo.innerHTML = `
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-10 col-md-10 col-lg-10 pe-0">
                                            <input type="number" placeholder="0" min="0" class="form-control" id="capacidad-txt">
                                        </div>
                                        <div class="col col-md col-lg">
                                            <label class="form-label">GB</label>
                                        </div>
        ...
        caraccuerpo.innerHTML = `
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-10 col-md-10 col-lg-10 pe-0">
                                            <input type="number" placeholder="0" min="0" class="form-control" id="potfuente-txt">
                                        </div>
                                        <div class="col col-md col-lg">
                                            <label class="form-label">W</label>
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-10 col-md-10 col-lg-10 pe-0">
                                            <input type="number" placeholder="0" min="0" class="form-control" id="tamvent-txt">
                                        </div>
                                        <div class="col col-md col-lg">
                                            <label class="form-label">mm</label>
                                        </div>
        ...
        caraccuerpo.innerHTML = `
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-10 col-md-10 col-lg-10 pe-0">
                                            <input type="number" placeholder="0" min="0" class="form-control" id="capram-txt">
                                        </div>
                                        <div class="col col-md col-lg">
                                            <label class="form-label">GB</label>
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-10 col-md-10 col-lg-10 pe-0">
                                            <input type="number" placeholder="0" min="0" class="form-control" id="frecram-txt">
                                        </div>
                                        <div class="col col-md col-lg">
                                            <label class="form-label">MHz</label>
                                        </div>
        ...
        caraccuerpo.innerHTML = `
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-10 col-md-10 col-lg-10 pe-0">
                                            <input type="number" placeholder="0" min="0" class="form-control" id="tamaño-txt">
                                        </div>
                                        <div class="col col-md col-lg">
                                            <label class="form-label">mm</label>
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-10 col-md-10 col-lg-10 pe-0">
                                            <input type="number" placeholder="0" min="0" class="form-control" id="grosor-txt">
                                        </div>
                                        <div class="col col-md col-lg">
                                            <label class="form-label">mm</label>
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" placeholder="0" min="0" class="form-control" id="cantidad-txt">
                                </div>
        `
    }
